...
## Example Dataset
All example data will be uploaded to a Dryad Digital Repository (doi:10.5061/dryad.b2rbnzsc8), as the files are too large for GitHub. To run the example data, download the exampleData directory from DRYAD, then run the R scripts in the ClinePlotR/scripts directory.
